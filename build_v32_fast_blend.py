...
print("Loading Fast V32 5-Fold CV Predictions...")
try:
    raw = pd.read_csv('v32_fast_predictions.csv')
except FileNotFoundError:
    print("Cannot build v32 fast. v32_fast_predictions.csv not found.")
    exit(1)
...
out.to_csv('submission_v32_fast_blend.csv', index=False)

print(f"Built v32 FAST Ultimate Submission!")
print(f"Changed {changed_from_baseline} predictions from the baseline utilizing the robust 5-Fold Cross Validated model with Pseudo-Labels!")
