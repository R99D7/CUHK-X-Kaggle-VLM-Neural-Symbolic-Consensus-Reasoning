...
print("Loading CNN-Transformer Raw Predictions...")
try:
    raw = pd.read_csv('transformer_raw_predictions.csv')
except FileNotFoundError:
    print("Cannot build v31. transformer_raw_predictions.csv not found.")
    exit(1)
...
out.to_csv('submission_v31_transformer_blend.csv', index=False)

print(f"Built v31 CNN-Transformer Submission!")
print(f"Changed {changed_from_baseline} predictions from the baseline for visual categories.")
