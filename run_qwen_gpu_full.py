...
df_qwen.to_csv('submission_qwen_local_full.csv', index=False)
print("Finished Qwen local inference!")

# Blend with ultimate_v12 (the strongest diversity ensemble)
df_base = pd.read_csv('submission_ultimate_v12.csv')
...
df_base.to_csv('submission_ultimate_v13_qwen.csv', index=False)
print("Finished creating final blended submission_ultimate_v13_qwen.csv!")
