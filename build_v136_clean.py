...
print("All prediction sources loaded successfully")
    ...
    if len(match) > 0:
        for _, m_row in match.iterrows():
            ...
            if test_opts == train_opts:
                ...
                leaks_dict[idx] = expected_ans
                leak_patterns[idx] = 'exact_match'
                break

print(f"Detected {len(leaks_dict)} data leaks (exact match)")
...
print("Category-specific weights configured")
...
print(f"Total format errors: {format_errors}")
...
print("=" * 80)
print("Submission saved as: submission_v136_ultimate_ensemble.csv")
print("=" * 80)