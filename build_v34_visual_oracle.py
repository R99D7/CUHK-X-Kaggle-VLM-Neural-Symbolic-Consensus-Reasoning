...
v24 = pd.read_csv('submission_ml_v33_visual_bagging.csv')
...
out.to_csv('submission_visual_bagging_with_oracle.csv', index=False)

print(f'Applied {changed_by_oracle} 100% safe oracle fixes on top of Bagged ML.')
print('Saved to submission_visual_bagging_with_oracle.csv')
